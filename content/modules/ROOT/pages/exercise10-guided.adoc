...
[start=2]
2. `Virtualization` → `VirtualMachines` に移動し、割り当てられたユーザーアカウントのプロジェクトを選択します。
...
仮想マシン `exercise10-b` に対して、手順15、16、17、18を繰り返してください。
...
[start=6]
6. 仮想マシン `exercise10-a` と `exercise10-b` で使用されているセカンダリ ネットワークを取得します。
